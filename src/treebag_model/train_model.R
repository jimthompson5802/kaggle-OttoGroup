...
WORK.DIR <- "./src/treebag_model"  # modify to specify directory to contain model artififacts
...
CARET.TRAIN.PARMS <- list(method="treebag")   # Replace MODEL.METHOD with appropriate caret model
