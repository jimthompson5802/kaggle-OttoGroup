###
# training gbm model based on factor predictors
###
...
WORK.DIR <- "./src/gbm3_model"  # modify to specify directory to contain model artififacts
...
MODEL.COMMENT <- "predictors are all factor variables, binning in groups of 5"
