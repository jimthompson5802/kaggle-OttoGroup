...
WORK.DIR <- "./src/stk_model/lgst2_1"  # modify to specify directory to contain model artififacts
...
# CARET.TUNE.GRID <- expand.grid(nIter=c(500))
...
set.seed(29)
idx <- sample(nrow(train1.raw),FRACTION.TRAIN.DATA*nrow(train1.raw))
