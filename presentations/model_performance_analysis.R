...
modPerf.df <- subset(modPerf.df,!grepl("stk_model",dir))
...
png("./presentations/model_runs_analysis.png",width=11,height=8.5, units="in",res=300)
print(p1)
dev.off()
...
png("./presentations/model_score_analysis.png",width=11,height=8.5, units="in",res=300)
print(p2)
dev.off()
